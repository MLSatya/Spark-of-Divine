 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/customer-booking-confirmed.php.
 *
...
echo __('Your booking has been confirmed.', 'spark-of-divine-scheduler') . "\n\n";
...
echo __('We look forward to seeing you!', 'spark-of-divine-scheduler') . "\n\n";
