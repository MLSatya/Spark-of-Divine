 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/customer-booking-reminder.php.
 *
...
echo __('This is a friendly reminder about your upcoming booking.', 'spark-of-divine-scheduler') . "\n\n";
...
echo __('We are looking forward to seeing you soon! If you need to reschedule, please contact us as soon as possible.', 'spark-of-divine-scheduler') . "\n\n";
